  ...
  return (
    ...
    >
       <Typography component="h1" variant="h5">
          InvoiSmart - Main page
        </Typography>
    <Paper style={{ width: "350px"} }>
      <MenuList > 
        <MenuItem onClick={clickInvoicesList}
        ...
        <MenuItem onClick={clickCreateInvoice}
          className={classes.menuItem}>
          <ListItemIcon className={classes.icon}>
            <CreateOutlinedIcon />
          </ListItemIcon>
        ...
        <MenuItem onClick={clickCreateSubscriber}
          className={classes.menuItem}>
          <ListItemIcon className={classes.icon}>
        ...
        <MenuItem onClick={clickPaymentPending}
          className={classes.menuItem}>
          <ListItemIcon className={classes.icon}>
        ...
        <MenuItem onClick={clickPaymentUpdate}
          className={classes.menuItem}>
          <ListItemIcon className={classes.icon}>
            <PaymentOutlinedIcon />
          </ListItemIcon>
        ...
        <MenuItem onClick={clickUpdatePassword}
          className={classes.menuItem}>
          <ListItemIcon className={classes.icon}>
            <VpnKeyOutlinedIcon />
          </ListItemIcon>
